function(ngm_add_nsight)
    add_library(ngm_nsight STATIC
        ...
        "${PROJECT_SOURCE_DIR}/src/nsight/ProfileEvidence.cpp")
...
function(ngm_add_nsight_checks)
    ngm_add_check(ngm_profile_evidence_check SOURCES "${PROJECT_SOURCE_DIR}/tests/ProfileEvidenceCheck.cpp"
        LIBRARIES ngm_nsight
        ARGS "${PROJECT_SOURCE_DIR}/tests/fixtures/profile-2026.3.1"
            "${PROJECT_SOURCE_DIR}/tests/fixtures/profile-2026.2.0")
